...
2.  **Anexe o Cluster:** Anexe os notebooks a um cluster PySpark ativo.
3.  **Execução:** Execute os notebooks sequencialmente (01 ao 04) para replicar todo o pipeline de MLOps.
